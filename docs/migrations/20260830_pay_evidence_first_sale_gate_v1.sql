-- Add Pay Evidence Pack Pro to the existing product-scoped first-sale gate.
...
begin
  ...
  if exists (
    ...
    raise exception '20260830_pay_evidence_first_sale_gate_v1 is already applied';
  end if;
...
as $$
begin
  if p_action = 'grant' and p_product_code in ('resume_pro', 'rental_application_pro', 'pay_evidence_pro') then
...
values ('20260830_pay_evidence_first_sale_gate_v1');
