...
- Next launch action: with explicit owner approval, enter the recorded Pay Evidence key values, deploy the exact source with Checkout off, then run sandbox and payment-off Production preflights before considering the product switch.
