...
create table if not exists purchase_entitlements (
  ...
  product_code text not null check (product_code in ('resume_pro', 'rental_application_pro', 'pay_evidence_pro', 'car_buy_pro', 'eofy_pro')),
...
alter table purchase_entitlements
  ...
  check (product_code in ('resume_pro', 'rental_application_pro', 'pay_evidence_pro', 'car_buy_pro', 'eofy_pro'));
