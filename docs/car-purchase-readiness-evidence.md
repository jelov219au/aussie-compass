...
Hash convention for the future collector: lowercase SHA256 of UTF-8 with CRLF
...
serialization, including exact identities and sorting rules. This canonical
collector format is still to be implemented and tested. The older inventory SQL's
