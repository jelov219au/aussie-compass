...
export const dailyPlaySets: readonly DailyPlaySet[] = [
  ...
  { id: "play-20260918", date: "2026-09-18",
    quiz: { ...review, id: "quiz-australia-national-gemstone", topicKey: "symbol:australia-national-gemstone-opal", question: "호주를 상징하는 공식 보석으로 지정된 것은 무엇일까요?", choices: ["루비", "사파이어", "오팔"], answer: 2, explanation: "정답은 오팔이에요. 호주는 1993년 오팔을 국가를 상징하는 보석으로 지정했어요. 작은 보석에도 나라의 상징이 담겨 있네요!", source: { title: "Australian Government · Department of the Prime Minister and Cabinet", url: "https://www.pmc.gov.au/honours-and-symbols/australian-national-symbols/australian-national-gemstone", checkedAt } },
    puzzle: { ...review, id: "word-stoked", topicKey: "slang:stoked", word: "STOKED", meaning: "아주 기쁘거나 신난 상태를 나타내는 말", explanation: "아주 기쁘거나 신난 기분을 나타내는 말이에요.", usage: "기다리던 좋은 소식을 듣고 기쁨을 전할 때 쓸 수 있어요. 오랜만에 친구를 만나게 된 상황을 떠올려보세요.", example: { en: "I'm stoked you're here!", ko: "네가 와서 정말 신나!" }, source: slang },
    choice: { ...review, id: "pick-imaginary-tram-announcement", topicKey: "imagination:tram-announcement-style", creative: true, question: "상상 속 멜버른 트램의 안내방송이 하루 동안 바뀐다면?", choices: ["정류장 이름을 짧은 노래로 불러주기", "정류장마다 새로운 말장난으로 소개하기"], reactions: ["내릴 곳 이름이 후렴구가 됐어요. 내린 뒤에도 자꾸 흥얼거리겠네요.", "목적지보다 다음 말장난이 궁금해져요. 그래도 내릴 정류장은 놓치지 마세요!"] } },
];
