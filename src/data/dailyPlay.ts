...
export const dailyPlaySets: readonly DailyPlaySet[] = [
  { id: "play-20260911", date: "2026-09-11",
    ...
    puzzle: { ...review, id: "word-bikkie", topicKey: "slang:bikkie", word: "BIKKIE", meaning: "비스킷을 친근하게 부르는 말", explanation: "비스킷의 별명이에요. 바삭한 간식에 잘 어울리는 짧은 말이죠.", source: slang },
  ...
  { id: "play-20260912", date: "2026-09-12",
    ...
    puzzle: { ...review, id: "word-esky", topicKey: "slang:esky", word: "ESKY", meaning: "음료를 차갑게 담아두는 아이스박스", explanation: "아이스박스를 이렇게 부르기도 해요. 소풍 짐에서 시원함을 맡는 상자예요.", source: slang },
  ...
  { id: "play-20260913", date: "2026-09-13",
    ...
    puzzle: { ...review, id: "word-sanga", topicKey: "slang:sanga", word: "SANGA", meaning: "샌드위치를 짧게 부르는 말", explanation: "샌드위치라는 뜻이에요. 도시락 메뉴를 짧게 말할 수 있겠죠.", source: slang },
  ...
  { id: "play-20260914", date: "2026-09-14",
    ...
    puzzle: { ...review, id: "word-cuppa", topicKey: "slang:cuppa", word: "CUPPA", meaning: "따뜻한 음료 한 잔을 부르는 말", explanation: "따뜻한 음료 한 잔을 뜻해요. 짧은 말에 잠깐 쉬자는 느낌도 담을 수 있겠네요.", source: slang },
  ...
  { id: "play-20260915", date: "2026-09-15",
    ...
    puzzle: { ...review, id: "word-avo", topicKey: "slang:avo", word: "AVO", meaning: "아보카도를 짧게 부르는 말", explanation: "아보카도의 줄임말이에요. 메뉴에서 만나도 이제 낯설지 않겠죠.", source: slang },
  ...
  { id: "play-20260916", date: "2026-09-16",
    ...
    puzzle: { ...review, id: "word-chokkie", topicKey: "slang:chokkie", word: "CHOKKIE", meaning: "초콜릿을 친근하게 부르는 말", explanation: "초콜릿을 이렇게 줄여 부르기도 해요. 이번 퍼즐은 철자까지 조금 달콤하네요.", source: slang },
  ...
  { id: "play-20260917", date: "2026-09-17",
    ...
    puzzle: { ...review, id: "word-bathers", topicKey: "slang:bathers", word: "BATHERS", meaning: "수영복을 뜻하는 호주식 표현", explanation: "수영복을 가리키는 말이에요. 지역이나 사람에 따라 쓰는 표현은 다를 수 있어요.", source: slang },
