...
export function getProCatalogProducts(resumeProLive: boolean, rentalProLive: boolean) {
  return [
    ...
    { id: "pay-evidence-pro", index: "03", icon: "document" as const, href: "/pay-evidence-pro", label: "급여 확인", name: "Pay Evidence Pro", price: formatPrice(payEvidenceProProduct.priceCents), live: false, review: true, outcome: "근무시간·Payslip 차이·증빙표·영문 문의문", free: "무료 급여 문제 대응 순서", freeHref: "/underpayment-guide" },
    { id: "eofy-pro", index: "04", icon: "money" as const, href: "/eofy-pro", label: "세금 준비", name: "EOFY Pack Pro", price: formatPrice(eofyProProduct.priceCents), live: false, review: true, outcome: "흩어진 소득·공제 자료와 세무사 질문 요약", free: "무료 택스 리턴 정보", freeHref: "/tax-return-guide" },
    { id: "leaving-australia-pro", index: "05", icon: "arrival" as const, href: "/leaving-australia-pro", label: "귀국 준비", name: "Leaving Pack Pro", price: formatPrice(leavingAustraliaProProduct.priceCents), live: false, review: true, outcome: "Bond·마지막 급여·세금·DASP 후속 확인", free: "무료 귀국·DASP 가이드", freeHref: "/leaving-australia-guide" },
  ].map((product) => ({
    ...product,
