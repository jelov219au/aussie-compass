...
const recommendations = {
  ...
  car: { href: "/car-buy-pro", name: "Car Buy Pack Pro", price: "A$14.90", description: "차량 가격만 보고 서두르지 않도록 첫해 비용과 송금 전 확인, 판매자 질문을 한곳에 모아요.", cta: "중고차 구매 준비 방식 보기", freeHref: "/used-car-comparison", freeLabel: "무료 비교표부터 사용하기" },
