    ...
    <section className="border-y border-navy/20 py-7" aria-labelledby="rental-portfolio-heading">
      ...
      <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted">정확한 주소나 에이전트 연락처 없이 별칭만 사용합니다. 최대 20개 집 후보의 서류 준비율과 후속 날짜를 이 브라우저에 따로 저장해요.</p>
        </div>
      ...
      {atLimit && <p className="mt-3 text-xs leading-5 text-muted">한 기기에서 집 후보는 최대 20개까지 관리할 수 있어요.</p>}
    </section>
  );
}
