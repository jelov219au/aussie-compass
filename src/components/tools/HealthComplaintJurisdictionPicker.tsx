...
const jurisdictions = [
  ...
  { id: "NT", label: "NT", name: "Health and Community Services Complaints Commission", href: "https://www.hcscc.nt.gov.au/", phone: "1800 004 474" },
] as const;
...
export function HealthComplaintJurisdictionPicker() {
  ...
  return (
    <section className="mt-14 rounded-[2rem] border-2 border-navy/10 bg-[#f7f0d9] p-6 sm:p-8" aria-labelledby="health-complaint-jurisdiction-heading">
      ...
      <h2 id="health-complaint-jurisdiction-heading" className="mt-2 text-2xl font-semibold leading-8 text-navy sm:text-3xl">
        거주 주·준주의 공식 창구만 확인하세요
      </h2>
      ...
      <div className="mt-6 max-w-sm">
        <label htmlFor="health-complaint-jurisdiction" className="block text-sm font-semibold text-navy">주·준주 선택</label>
        <select
      ...
      <p className="mt-4 text-xs leading-6 text-muted">선택값과 건강정보는 저장하거나 전송하지 않습니다. 보험 급여·회원·OSHC/OVHC 청구 문제는 먼저 보험사에 접수한 뒤 Private Health Insurance Ombudsman 경로를 이용하세요.</p>
    </section>
  );
}
