...
const topics = [
  ...
  { id: "resume-template", title: "호주 이력서 양식·제출 전 점검", path: "/resources/australia-resume-template-submission-checklist", campaign: "resume-template-free-pdf" },
  { id: "resume-job-ad-check", title: "이력서·Job Ad 공고 맞춤 근거 점검", path: "/resume-job-ad-checker", campaign: "resume-job-ad-evidence-check" },
