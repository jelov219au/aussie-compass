...
function event(uid:string,date:string,summary:string,description:string){return ["BEGIN:VEVENT",`UID:${uid}@hojucompass.com`,`DTSTART;VALUE=DATE:${date}`,`SUMMARY:${summary}`,`DESCRIPTION:${description}`,"END:VEVENT"].join("\r\n")}
