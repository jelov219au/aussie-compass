...
const targets: Target[] = [
  ...
  { path: "/resume-job-ad-checker", label: "이력서·공고 맞춤 점검", title: "호주 Job Ad, 이력서에 복사하기 전에 근거부터 확인하세요", body: "이력서와 공고를 서버 전송 없이 비교하고 같은 문구와 실제 경력 근거를 구분하세요.", cta: "무료 공고 맞춤 점검하기" },
...
const campaignCardCopy: Record<string, Pick<Target, "title" | "body" | "cta">> = {
  ...
  "resume-job-ad-evidence-check": { title: "공고 키워드, 그대로 복사하기 전에 근거부터 확인하세요", body: "이력서와 Job Ad를 로컬에서 비교하고 같은 문구와 실제로 설명할 수 있는 경험을 구분하세요.", cta: "무료 공고 맞춤 점검하기" },
