...
const guides: JurisdictionGuide[] = [
  ...
  { id: "NT", name: "Northern Territory", marketNote: "NT는 지역에 따라 선택 가능한 Retailer와 Remote customer 공급자가 달라요. 주소의 Retailer, 정부 Pricing Order와 공급 범위를 먼저 확인하세요.", compare: { label: "NT Electricity retailers", href: "https://www.powerwater.com.au/about/regulation/electricity-network-regulation-and-pricing/electricity-retailers" }, support: { label: "Power and Water pricing", href: "https://www.powerwater.com.au/pricing" }, dispute: { label: "Ombudsman NT complaints", href: "https://ombudsman.nt.gov.au/complaints" } },
];
