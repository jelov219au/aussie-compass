export function AustralianSky() {
  return (
    <div
      className="australia-poster-float relative isolate min-h-[24rem] overflow-hidden rounded-[2rem] bg-navy px-6 py-7 text-white shadow-[0_28px_70px_rgba(26,39,68,0.16)] sm:min-h-[27rem] sm:px-8 sm:py-9"
      aria-hidden="true"
    >
      ...
      >
        ...
        <g className="australia-constellation" fill="#F4D36A">
      ...
      <div className="absolute inset-x-0 bottom-0 h-[54%] bg-[#6f9aa4]">
        <div className="australia-sun-glow absolute -top-8 left-[12%] h-28 w-28 rounded-full bg-[#efd28a] sm:h-32 sm:w-32" />
        <svg viewBox="0 0 420 100" preserveAspectRatio="none" className="australia-land-drift absolute -top-10 h-20 w-full fill-[#d78b61]">
        ...
        <div className="absolute inset-x-0 bottom-0 h-[72%] bg-[#f4ead8] px-6 py-5 text-navy sm:px-8 sm:py-6">
          ...
          <p className="mt-3 text-[0.66rem] font-medium leading-5 tracking-[0.08em] text-navy/55">
