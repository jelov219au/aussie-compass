...
const stages = [
  { id: "prepare", number: "01", tab: "출국·도착 준비", title: "호주 생활의 기준부터 잡기", description: "예상 급여와 생활비, 관심 직업을 먼저 확인하면 도착 후 선택이 쉬워집니다.", links: [{ href: "/salary-calculator", label: "예상 급여 계산" }, { href: "/cost-of-living-calculator", label: "생활비 예산" }, { href: "/career-pathways", label: "직업·진로 탐색" }] },
