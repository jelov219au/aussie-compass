...
const stages = [
  ...
  { id: "work", number: "03", tab: "일자리 구하기", title: "이력서부터 지원 기록까지 이어가기", description: "호주식 영문 이력서를 만들고 공고, 면접과 다음 행동을 하나의 구직 프로젝트로 관리하세요.", links: [{ href: "/resume-builder", label: "영문 이력서 만들기" }, { href: "/resume-job-ad-checker", label: "공고 맞춤 근거 점검" }, { href: "/job-application-tracker", label: "지원 현황 관리" }] },
  { id: "settle", number: "04", tab: "생활 정착", title: "돈과 이동, 생활 서비스를 계획하기", description: "한국 면허 사용 조건부터 차량 비용과 생활 서비스 견적까지 같은 기준으로 확인하세요.", links: [{ href: "/overseas-driver-licence-guide", label: "해외면허 전환" }, { href: "/used-car-comparison", label: "중고차 비교" }, { href: "/service-quote-comparator", label: "서비스 견적 비교" }] },
  { id: "yearly", number: "05", tab: "세금·정기 점검", title: "택스 리턴과 반복 비용 점검하기", description: "EOFY 서류를 준비하고 실제 서비스 비용을 기록해 다음 신고와 지출 판단에 활용하세요.", links: [{ href: "/tax-return-guide", label: "택스 리턴 준비" }, { href: "/eofy-pro", label: "EOFY Pack Pro" }, { href: "/service-price-log", label: "서비스 가격 기록" }] },
