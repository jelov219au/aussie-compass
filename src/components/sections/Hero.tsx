      ...
      <Container>
        <div className="grid items-center gap-7 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          <div className="min-w-0">
            <p className="home-hero-eyebrow flex items-center gap-2 text-xs font-semibold">
            ...
            <h1 className="mt-4 text-[2.25rem] font-semibold tracking-[-0.04em] text-navy sm:text-5xl lg:text-[3.5rem]">
              호주 생활,<br /><span className="home-hero-accent">조금 더 가볍게.</span>
            </h1>
            <p className="mt-4 max-w-lg text-sm leading-7 text-muted sm:text-base">집을 구하고, 일을 시작하고, 내일을 준비하는 일.<br />지금 필요한 것부터 함께 풀어가요.</p>
          ...
          <div className="home-task-panel min-w-0 rounded-2xl p-5 sm:p-7">
            <p className="text-base font-semibold text-navy" data-home-observe="tasks">오늘은 어떤 도움이 필요하세요?</p>
            <HomeSearch />
          </div>
        </div>
      </Container>
