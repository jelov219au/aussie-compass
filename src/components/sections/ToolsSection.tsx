...
export function ToolsSection() {
  return <section id={sectionIds.tools} className="scroll-mt-20 bg-background py-16 sm:py-24" aria-labelledby="essential-tools-heading"><Container>
    ...
    <div className="mt-7 flex justify-end"><Link href="/tools" className="inline-flex min-h-11 items-center border-b-2 border-gold text-sm font-semibold text-navy">전체 도구 보기 <span className="ml-3" aria-hidden="true">→</span></Link></div>
  </Container></section>;
}
