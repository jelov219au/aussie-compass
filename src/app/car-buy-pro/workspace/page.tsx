...
export default function CarBuyProWorkspacePage() {
  requireLocalProductPreviewAccess();
  return <>
    <BreadcrumbJsonLd items={[{ name: "홈", path: "/" }, { name: "중고차 비교", path: "/used-car-comparison" }, { name: "Car Buy Pack Pro", path: "/car-buy-pro" }, { name: "개발 프리뷰", path: "/car-buy-pro/workspace" }]} />
    <Header />
