...
export default function TaxPrepTrackerPage() {
  return <>
    ...
    <main className="site-screen tool-screen py-8 sm:py-10"><Container>
      ...
      <a href="#tax-record-entry" className={actionClass("primary", "mt-5")}>소득·지출 한 건 기록하기 ↓</a>
      ...
      <p className="mb-4 text-sm leading-7 text-muted">장부의 기본값은 현재 진행 중인 회계연도입니다. 최근 종료 연도의 신고를 준비한다면 연도를 바꿔 확인하세요. CSV는 백업·검토용이며 이 도구에는 재가져오기 기능이 없습니다. 원본 파일과 증빙 위치는 따로 보관하세요.</p>
      <TaxPrepTracker />
      <div className="mt-8"><TaxTimeReminder purpose="current-ledger" /></div>
