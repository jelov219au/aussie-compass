...
export default async function EofyProWorkspacePage() {
  ...
  if (accessProtected && !await getActiveEofyProEntitlement()) {
    redirect("/eofy-pro?access=required");
  }
