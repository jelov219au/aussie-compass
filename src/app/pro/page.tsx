...
function getProducts(resumeProLive: boolean) {
  return [
    ...
    { index: "02", icon: "home" as const, href: "/rental-application-pro?from=pro-hub", label: "집 구하기", name: "Rental Pack Pro", price: "A$14.90", status: "유료 검증 준비", outcome: "신청 서류·개인정보·영문 소개문 준비", free: "무료 집 방문·계약 체크", freeHref: "/property-inspection-checklist" },
