...
function getProducts(resumeProLive: boolean) {
  return [
    { index: "01", href: "/resume-pro?from=pro-catalog-card", label: "구직 준비", name: "Resume Pro", price: "A$19.90", status: resumeProLive ? "현재 이용 가능" : "결제 설정 확인 중", outcome: "지원 공고별 이력서·커버레터·제출 전 점검", free: "무료 이력서·공고 근거 점검", freeHref: "/resume-job-ad-checker" },
