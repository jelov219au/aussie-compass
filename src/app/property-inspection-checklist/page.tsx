...
const bookingQuestions = [
  ...
  ["If a bond scheme applies to this agreement, who will lodge it, when, and what receipt will I receive?", "이 계약에 Bond 제도가 적용되는 경우 누가 언제 접수하고 어떤 영수증을 주나요?"],
  ...
  ["If a condition report applies, what form and deadline should I use? If not, how will we record the existing condition in writing?", "Condition report가 적용되면 어떤 양식과 기한을 쓰나요? 적용되지 않으면 기존 상태를 어떤 서면 기록으로 합의하나요?"],
];
