...
import { carBuyProProduct, carBuyProPurchaseTermsVersion, payEvidenceProduct, payEvidencePurchaseTermsVersion, rentalProProduct, rentalProPurchaseTermsVersion, resumeProProduct, resumeProPurchaseTermsVersion } from "@/lib/commerce";
        ...
        <Container className="max-w-6xl">
          ...
          <div className="mt-8 grid gap-8 border-b border-navy/20 pb-10 lg:grid-cols-[1fr_18rem] lg:items-end">
            ...
            <aside className="border-l-2 border-gold pl-5 text-sm leading-6 text-muted">
              ...
              <span className="mt-1 block">Resume {resumeProPurchaseTermsVersion}</span><span className="block">Pay {payEvidencePurchaseTermsVersion}</span><span className="block">Rental {rentalProPurchaseTermsVersion}</span><span className="block">Car Buy {carBuyProPurchaseTermsVersion}</span>
          ...
          <div className="mt-12 divide-y divide-border border-y border-border">
            ...
            <section className="grid gap-5 py-8 lg:grid-cols-[15rem_1fr]">
              ...
              <div className="max-w-3xl space-y-3 text-sm leading-7 text-muted">
                <p>Resume Pro는 {resumePrice} AUD, Pay Evidence Pro는 {payPrice} AUD, Rental Application Pack Pro와 Car Buy Pack Pro는 각각 {rentalPrice} AUD와 {carBuyPrice} AUD의 1회 결제 상품입니다. 결제 전에 Stripe 화면에서 구매 상품, 최종 금액, 결제수단과 인보이스 정보를 확인할 수 있으며 Hoju Compass는 전체 카드번호나 CVC를 직접 받지 않습니다.</p>
            ...
            <section className="grid gap-5 py-8 lg:grid-cols-[15rem_1fr]">
              ...
              <div className="max-w-3xl space-y-3 text-sm leading-7 text-muted">
                <p>이력서·커버레터·근무시간·급여 계산·Rental Pack의 프로필·집 후보·영문 문구와 Car Buy Pack의 차량 별칭·비용·확인 메모는 별도 안내가 없는 한 현재 브라우저에서 처리됩니다. 결제 이용권 데이터베이스에는 작업 공간의 문서 원문을 저장하지 않습니다.</p>
