...
export const metadata = createPageMetadata({ title: "Pay Evidence Pack Pro 개발 프리뷰 | Hoju Compass", description: "근무시간, Payslip Gross, 입금과 증빙 상태를 급여기간별로 정리하고 영문 급여 확인 요청문을 만드세요.", path: "/pay-evidence-pro/workspace" });
