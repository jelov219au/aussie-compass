...
const guides = [
  ...
  { href: "/resources/australia-job-ending-final-pay-dismissal-guide", title: "퇴사·해고 뒤 마지막 급여와 신청기한", description: "종료 유형별 마지막 급여를 정리하고 해고 관련 신청기한을 별도로 확인합니다.", tag: "고용 종료", covers: ["Notice·미사용 연차·마지막 급여 대조", "해고 관련 21일 신청기한과 급여 분쟁 구분"] },
];
