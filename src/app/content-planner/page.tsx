...
export const metadata = { ...createPageMetadata({ title: "SNS·커뮤니티 콘텐츠 발행 플래너 | Hoju Compass", description: "호주 생활 콘텐츠의 주제, 채널, 형식과 발행일을 정하고 캠페인 링크와 카드뉴스 제작까지 이어가세요.", path: "/content-planner" }), robots: { index: false, follow: false } };
