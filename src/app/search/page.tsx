...
const coreItems:SearchItem[]=[
  ...
  {href:"/purchase-information",type:"자료",title:"구매·환불 안내",description:"유료도구별 가격과 제공 범위, 판매자 정보, 영수증, 이용권 복구·환불 요청 안내",keywords:["환불","결제","영수증","인보이스","ABN","소비자권리","Stripe","구매"]},
  ...
  {href:"/terms",type:"자료",title:"서비스 이용 조건",description:"무료·유료 도구의 이용 범위, 결제 조건, 접근 복구와 소비자 권리",keywords:["약관","이용조건","terms","서비스","결제조건","디지털제품","소비자보장"]},
  ...
  {href:"/used-car-comparison",type:"도구",title:"호주 중고차 구매처·체크리스트",description:"Facebook Marketplace, Gumtree, Carsales에서 찾고 PPSR·검사 후 후보와 비용 비교",keywords:["차","자동차","rego","보험","연료","차량","중고차","수리 약속","검사 보고서","PPSR","차량 비교","중고차 어디서","facebook marketplace","gumtree","carsales","messenger","whatsapp"]},
  {href:"/car-purchase-pro",type:"도구",title:"Car Purchase Pack Pro — 중고차 거래노트 준비 중",description:"가격 미정·결제 미오픈. 검사 뒤 질문, 판매자 수리 약속·증빙, 독립 재확인과 최종 결정 기록을 준비하며 무료 후보·비용 비교표를 먼저 이용할 수 있어요.",keywords:["중고차","수리 약속","검사 보고서","PPSR","차량 비교","거래노트","가격 미정","결제 미오픈"],stateLabel:"준비 상태 · 가격 미정 · 결제 미오픈",freeHref:"/used-car-comparison",freeLabel:"무료 후보·비용 비교표 먼저 사용"},
...
const articleItems: SearchItem[] = articles.map((article) => ({
  ...
  keywords: [
    ...
    ...(article.slug === "used-car-inspection-report-next-steps" ? ["중고차", "수리 약속", "검사 보고서", "독립 재확인", "차량 비교"] : []),
    ...(article.slug === "used-car-ppsr-purchase-day-checklist" ? ["중고차", "PPSR", "차량 비교", "구매 당일"] : []),
    ...(article.slug === "australia-rental-moving-out-bond-refund-guide" ? ["렌트 보증금", "Bond 반환", "보증금 못 받음", "퇴거 분쟁"] : []),
  ],
}));
