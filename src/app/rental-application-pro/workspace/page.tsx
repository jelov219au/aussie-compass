...
import { RentalProAccessTools } from "@/components/tools/RentalProAccessTools";
import { Container } from "@/components/ui/Container";
import { getActiveRentalProEntitlement } from "@/lib/rentalProAccess";
...
export default async function RentalApplicationWorkspacePage() {
  ...
  if (accessProtected && !await getActiveRentalProEntitlement()) redirect("/rental-application-pro?access=required");
