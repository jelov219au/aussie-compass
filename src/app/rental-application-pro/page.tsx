...
import { RentalProCheckoutForm } from "@/components/tools/RentalProCheckoutForm";
import { Container } from "@/components/ui/Container";
import { canCreateRentalTestCheckout, getRentalPaymentReadiness } from "@/lib/commerce";
...
export default async function RentalApplicationProPage({ searchParams }: Props) {
  ...
  const paymentReadiness = getRentalPaymentReadiness();
  const testCheckoutAvailable = canCreateRentalTestCheckout();
