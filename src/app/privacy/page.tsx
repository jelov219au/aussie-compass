...
const sections = [
  ["현재 수집하는 개인정보", "Hoju Compass는 현재 회원 계정, 이메일 구독, 문의 양식 또는 광고 프로필을 운영하지 않습니다. 도구에 입력한 이력서·구직·예산·체크리스트 내용은 별도 안내가 없는 한 서버로 제출되지 않습니다. Resume Pro 결제를 직접 시작한 경우에만 아래 결제 처리 내용이 적용됩니다."],
