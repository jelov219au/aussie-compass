...
const sections = [
  ...
  ["브라우저에 저장되는 내용", "일부 도구는 진행 상태와 입력값을 브라우저의 localStorage에 저장합니다. 같은 기기와 브라우저에서 다시 열기 위한 기능이며, 브라우저 사이트 데이터 삭제 또는 각 도구의 초기화 기능으로 지울 수 있습니다. 공용 기기에서는 사용 후 삭제하세요."],
