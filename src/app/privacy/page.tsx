...
const sections = [
  ...
  ["Stripe 결제와 이용권", "Resume Pro 결제를 시작하면 Stripe 결제 화면으로 이동하며 Stripe가 사용자가 입력한 연락처와 결제 정보를 처리합니다. 테스트 환경에서는 실제 청구가 일어나지 않습니다. Hoju Compass는 전체 카드번호나 카드 보안번호를 직접 받지 않습니다. 서버에는 Stripe 이벤트·결제 세션·결제수단 관련 식별자, 제품 코드, 확인한 구매 조건의 버전, 이용권 상태와 처리 시각을 저장할 수 있습니다. 작업 공간의 이력서·커버레터 내용은 이 이용권 데이터베이스에 저장하지 않습니다."],
