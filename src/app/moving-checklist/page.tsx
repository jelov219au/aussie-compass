...
<section className="mt-12 rounded-2xl bg-navy p-6 text-white sm:p-8" aria-labelledby="moving-utility-heading"><p className="text-xs font-semibold uppercase tracking-[0.18em] text-gold">03 · 서비스 이전</p><h2 id="moving-utility-heading" className="mt-2 text-2xl font-semibold">‘주소 변경’과 ‘서비스 이전’은 다릅니다</h2><div className="mt-6 grid gap-6 text-sm leading-7 text-white/75 md:grid-cols-2"><div><h3 className="font-semibold text-white">기존 주소 종료</h3><ul className="mt-3 space-y-2"><li>최종 사용일·계량기 수치·마지막 Bill 주소</li><li>모뎀·라우터·열쇠 등 대여장비 반납</li><li>Direct debit 종료와 Credit 환급 계좌</li><li>Hardship·Payment plan과 남은 Debt 처리</li><li>보험 보장 종료시간과 이삿짐 운송 중 보장</li></ul></div><div><h3 className="font-semibold text-white">새 주소 시작</h3><ul className="mt-3 space-y-2"><li>전기·가스 연결일과 Connection fee</li><li>Plan 이름·Tariff·Supply·Usage rate 확인서</li><li>인터넷 기술·설치 일정과 임시 데이터</li><li>Contents·차량보험 주소와 주차 조건 변경</li><li>건물 엘리베이터·Loading zone 예약 승인</li></ul></div></div><div className="mt-7 rounded-xl border border-white/20 bg-white/10 p-5"><h3 className="font-semibold text-white">첫 Energy Bill까지 이사 프로젝트에 포함하세요</h3><p className="mt-2 text-sm leading-7 text-white/75">입주일 Meter 사진, 연결 확인서와 Plan 문서를 보관하고 첫 Bill의 주소·기간·Actual 또는 Estimated reading·Rate를 대조하세요. 금액이 다르거나 납부가 어렵다면 Due date 전에 Retailer에 서면으로 문의하는 흐름까지 정리했습니다.</p><Link href="/resources/australia-energy-plan-moving-home-guide" className="mt-4 inline-flex min-h-11 items-center border-b-2 border-gold text-sm font-semibold text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-navy">전기·가스 연결과 첫 Bill 가이드 →</Link></div></section>
