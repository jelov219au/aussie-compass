      ...
      <main className="py-12 sm:py-16">
        <Container className="max-w-5xl">
          ...
          <section className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <Link href="/resume-pro/restore" className="border border-border bg-white p-5"><span className="text-xs font-semibold uppercase tracking-[0.16em] text-gold">Resume Access</span><strong className="mt-2 block text-navy">Resume Pro 복구 →</strong><span className="mt-2 block text-sm leading-6 text-muted">Resume Pro용 1회용 코드로 이 기기의 접근을 복구합니다.</span></Link>
            <Link href="/rental-application-pro/restore" className="border border-border bg-white p-5"><span className="text-xs font-semibold uppercase tracking-[0.16em] text-gold">Rental Access</span><strong className="mt-2 block text-navy">Rental Pack 복구 →</strong><span className="mt-2 block text-sm leading-6 text-muted">Rental Pack용 1회용 코드로 이 기기의 접근을 복구합니다.</span></Link>
