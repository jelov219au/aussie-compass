...
export const metadata = createPageMetadata({ title: "저축 목표·비상금 프로젝트 | Aussie Compass", description: "저축 목표를 계산하고 완료 기록, 진행률과 캘린더 반복 리마인더로 꾸준히 관리하세요.", path: "/savings-goal-calculator" });
