...
export const metadata = createPageMetadata({ title: "SNS·커뮤니티 콘텐츠 성과 기록판 | Hoju Compass", description: "게시물별 조회, 링크 클릭과 저장 합계를 직접 기록하고 효과가 좋은 채널과 주제를 비교하세요.", path: "/content-performance" });
