...
- EOFY Pack Pro local workspace plus purchase-ready signed access, one-time recovery and refund-revocation foundation for income-source readiness, deduction-candidate evidence notes, accountant questions, and a text summary without receipt uploads or refund estimates
- Rental Application Pack Pro preview and local multi-property workspace with reusable applicant details, application stages and due-action warnings, eight state-and-territory official application checkpoints, document and privacy readiness, three English contact drafts, PDF/TXT export, and JSON backup restore without document uploads
...
- Car Buy Pack Pro preview and local workspace with first-year vehicle cost comparison, stop-before-payment checks, seller-type English questions, official PPSR and registration handoffs, and private TXT/JSON exports without VIN or seller details
