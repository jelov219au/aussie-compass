...
- Rental Pack Pro paid-validation flow with a separate Stripe Price gate, product-scoped Checkout entitlement, signed device access, one-time recovery and refund revocation; its local workspace supports up to 20 properties, a reusable applicant profile, due-action warnings, eight jurisdiction guides, three English message drafts, PDF/TXT export and JSON backup without document uploads. Public charging stays off until controlled test and live verification pass.
