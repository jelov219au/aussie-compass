...
const workspace = readFileSync(new URL("../src/components/tools/PayEvidenceWorkspace.tsx", import.meta.url), "utf8") + readFileSync(new URL("../src/lib/payEvidenceOutput.ts", import.meta.url), "utf8");
...
assert.match(workspace, /return draft\.rateBasisType !== "unsure"[\s\S]*draft\.sourceNote\.trim\(\)[\s\S]*rateBasisCheckedOn[\s\S]*draft\.evidence\.basis === "ready"/);
