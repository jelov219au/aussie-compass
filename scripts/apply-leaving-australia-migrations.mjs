...
console.log(`LEAVING_AUSTRALIA_MIGRATION=${ready ? "PASS" : apply ? "FAIL" : "PENDING"} checkout=off secrets_printed=no`);
if (apply) assert.equal(ready, true, "Leaving Australia migration postflight failed.");
