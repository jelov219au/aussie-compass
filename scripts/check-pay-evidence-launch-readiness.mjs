...
const required = [
  ...
  ["PAY_EVIDENCE_PRO_PAYMENTS_ENABLED", () => env("PAY_EVIDENCE_PRO_PAYMENTS_ENABLED") === "true"],
  ["STRIPE_SECRET_KEY", () => /^sk_(test|live)_/.test(env("STRIPE_SECRET_KEY"))],
  ["STRIPE_WEBHOOK_SECRET", () => /^whsec_/.test(env("STRIPE_WEBHOOK_SECRET"))],
  ["STRIPE_PAY_EVIDENCE_PRO_PRICE_ID", () => /^price_/.test(env("STRIPE_PAY_EVIDENCE_PRO_PRICE_ID"))],
...
console.log("Pay Evidence Pack Pro local launch gate");
