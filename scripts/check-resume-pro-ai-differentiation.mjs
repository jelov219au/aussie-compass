...
const checks = [
  ...
  [section.includes("회사별 이력서·커버레터·STAR 메모와 지원서 묶음") && workspace.includes("persistResumeProApplicationStore") && applicationStorage.includes("items.slice(0, maximumApplications)") && applicationStorage.includes("maximumApplications = 30") && workspace.includes("downloadApplicationKit") && workspace.includes("resumeProStarStoriesStorageKey"), "Pro의 재사용 설명은 실제 저장·내보내기 기능과 일치해야 합니다."],
