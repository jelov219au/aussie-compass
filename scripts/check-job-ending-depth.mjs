...
assert.ok(depthContract.includes("articleBlocks.length, 35"), "content-depth baseline must include the audited job ending guide after public-holiday deduplication");
