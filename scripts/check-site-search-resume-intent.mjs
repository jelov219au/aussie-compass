...
const fixtures = [
  { href: "/resume-pro", type: "도구", title: "Resume Pro — 공고별 이력서·커버레터", description: "회사별 지원 자료", keywords: ["resume", "STAR", "selection criteria", "cover letter"] },
  { href: "/salary-calculator", type: "도구", title: "급여 계산기", description: "급여 계산", keywords: ["급여"] },
  { href: "/resources/english-resume-achievement-examples", type: "자료", title: "호주 이력서 성과 문장", description: "근거를 확인하는 STAR 글", keywords: ["이력서", "resume", "CV", "STAR 예시", "selection criteria", "cover letter", "호주 취업 이력서"] },
  { href: "/resume-builder", type: "도구", title: "무료 영문 이력서 빌더", description: "브라우저 저장과 PDF", keywords: ["이력서", "resume", "CV", "STAR 예시", "selection criteria", "cover letter", "호주 취업 이력서"] },
];
...
for (const query of ["이력서", "resume", "CV", "STAR 예시", "selection criteria", "cover letter", "호주 취업 이력서"]) {
...
for (const query of ["STAR 예시", "selection criteria", "cover letter", "호주 취업 이력서"]) {
